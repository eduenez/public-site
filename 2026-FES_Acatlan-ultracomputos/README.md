...
**Facultad de Estudios Superiores Acatlán, UNAM** · 22 de mayo de 2026

Charla de investigación (1 hora, en español) sobre la clasificación topológica de
cómputos profundos. Síntesis de dos artículos:

- Alva, Dueñez, Iovino, Walton (2024) — *Deep equilibria: existence and computability.*
...
Cuatro cuadernos interactivos. Haz clic en la insignia para abrir en Google Colab, o
descarga el `.ipynb` y ejecútalo localmente con `jupyter lab` / `jupyter notebook`.

| Notebook | Tema | Abrir en Colab |
|----------|------|----------------|
| `newton_fractals.ipynb` | Método de Newton como cómputo profundo; fractales y la dicotomía Fatou/Julia. | [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/eduenez/public-site/blob/main/2026-FES_Acatlan-ultracomputos/notebooks/newton_fractals.ipynb) |
